...
int tile_Ordering(int **current_state, int **goal_state, int move)
{
    ...
    cout << "Current Manhattan number : " << manhattan << endl
         << endl
         << endl;
    for (int i = 0; i < 3; i++)
    {
...
int main()
{
    int **initial = new int *[3]; // Allocating an array of 3 int pointers - These represents rows
    for (int i = 0; i < 3; i++)
    {
        initial[i] = new int[3]; // These represents columns
    }

    int **final = new int *[3]; // Allocating an array of 3 int pointers - these represents rows
    for (int i = 0; i < 3; i++)
    {
    ...
    int player_Input;
    cout << "Enter initial board configuration - 0 denotes empty position/hollow tile" << endl;
    for (int i = 0; i < 3; i++)
    {
        for (int j = 0; j < 3; j++)
        {
    ...
    cout << "----------------------------------------------------------------------------" << endl;
    cout << "Enter final board configuration - 0 denotes empty position/hollow tile" << endl;
    for (int i = 0; i < 3; i++)
        for (int j = 0; j < 3; j++)
        {
            cout << "Enter input A[" << i << "][" << j << "] = " << endl;
